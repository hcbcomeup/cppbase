 ...
 * @details Core cross-platform config, compiler/OS detection, C++ standard
 * check
 * @note All macros are preprocessor definitions, compile-time constants, zero
 * runtime cost
 * @note This is the first included header for all cppbase components, compile
 * foundation
 */
 ...
 * @note Cross-platform core macro, used for conditional compilation of
 * OS-specific code
 */
 ...
 * @note _WIN32: match both Windows 32/64 bit; __linux__: Linux; __APPLE__:
 * macOS/iOS
 */
#ifdef _WIN32
...
/**
 * @brief Auto detect current compiler, set CPPBASE_COMPILER to corresponding
 * value
 * @note _MSC_VER: MSVC compiler; __GNUC__: GCC compiler; __clang__: Clang
 * compiler
 */
#ifdef _MSC_VER
 ...
 * @note CPPBASE_IS_GNU: GCC + Clang (GNU family compilers), common for
 * Unix-like systems
 */
